            ...
            <div id="alat-container" class="space-y-3">
                ...
                <div class="alat-row flex items-center gap-3">
                    ...
                    <div class="relative flex-1 alat-dropdown">
                        {{-- Search --}}
                        <input type="text" placeholder="Cari alat..." autocomplete="off"
                        ...
                        <input type="hidden" name="alat_id[]" class="alat-id" required>
                        {{-- Dropdown --}}
                        <div class="alat-options hidden absolute z-20 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                            
                            @foreach($alats as $alat)
                                <button type="button" 
                                    class="alat-option w-full text-left px-3 py-2 hover:bg-blue-50 transition" data-id="{{ $alat->id }}" data-name="{{ $alat->nama_alat }}" data-stok="{{ $alat->stok }}">
                                    <div class="font-medium text-gray-800">
                                        {{ $alat->nama_alat }}
                                    </div>
                                    <div class="text-xs text-gray-500">
